...
| Full dataset size | 69,589 records |
| Free sample size | 1,000 records (1.44%) |
| Last export | 2026-04-16T22:05:12.694832+00:00 |
| Download | [Latest release asset](https://github.com/Beamstation-Datasets/all-restaurants-in-texas-us-sample-584362/releases/download/sample-latest/beamstation_584362_restaurants-us-tx_SAMPLE_DIST.csv) |
...
Search for dataset ID `584362` on BeamStation if you want the exact commercial listing.
